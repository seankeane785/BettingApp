...
RESEARCH SOURCE HIERARCHY AND PROCEDURE: Verify every fixture with the official competition fixture source. SoccerStats is the mandatory primary current-season aggregate source for both Premier League and Championship. Use its current-season competition, team, home, away, and statistics pages first for match result, double chance, draw no bet, BTTS, total goals, team goals, team to score, clean sheets, total corners, and team corners; attempt every one before declaring it unavailable. Where explicitly available, collect completed current-season league match count; W/D/L and home/away records; scored and conceded records; BTTS and goal-threshold hit rates; clean sheets; match-corner threshold hit rates; team corners-for and opponent corners-against evidence; relevant home/away splits; and current-season competition benchmarks.

Use direct completed-match pages only for specialist evidence unavailable from SoccerStats, in this exact fallback order: FotMob direct completed-match page; SofaScore direct completed-match page; official Premier League or EFL completed-match centre. Use them only where an exact numeric team-level value is visibly exposed for a completed current-season league match: total cards, team cards, team shots, team shots on target, or a missing team-corner or match-corner observation needed for an exact threshold count. A page merely stating that it offers statistics without exposing the numeric value is not evidence. WinDrawWin is prohibited: never cite or use it for evidence, benchmarks, candidates, probabilities, confidence, or availability.
