...
describe('analysis presentation helpers', () => {
  ...
  it('marks Moderate and Avoid candidates as excluded', () => { const { fixture, research } = packs(); research.fixtures[0].dataQuality = 'insufficient'; const candidates = analyse(fixture, research, defaultModelSettings('2026-09-01T10:00:00Z', 24)).candidates; expect(candidates.every(isExcludedFromBuilders)).toBe(true) })
