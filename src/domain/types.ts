...
export interface MarketCoverage { marketGroup: MarketGroup; status: 'analysed' | 'unavailable'; candidateMarketRecordsSupplied: number; supportingOnlyRecordsSupplied: number; matchingBenchmarksSupplied: number; candidateCount: number; missingEvidence: string[]; unavailableReason: string | null }
