...
export interface CompetitionMarketBenchmark { marketKey: string; marketGroup: MarketGroup; selectionLabel: string; sampleSize: number; hits: number; supportPercent: number | null; sourceIds: string[] }
...
export interface ResearchPack { packName: 'ResearchPack v1'; schemaVersion: '1.0.0' | '1.1.0' | '1.2.0' | '1.3.0'; fixturePackRef: { schemaVersion: '1.0.0'; fixtureDate: string }; generatedAt: string; dataStatus: 'synthetic' | 'real'; sources: SourceReference[]; competitionBenchmarks?: CompetitionBenchmark[]; fixtures: ResearchFixture[] }
