...
For both teams, obtain current-season, team-level evidence where available: last five and last ten form; home or away record; goals scored and conceded; relevant team-level market hit rates with sample sizes and hits; shots; shots on target; corners; cards; and xG only where sourced. Also research opponent-strength context, credible team news, fixture congestion, and managerial changes. Populate every mandatory ResearchPack v1 evidence object and field. Use null for unavailable numeric or optional evidence, and use status "unknown" with null detail for unavailable or conflicting context. Never invent numbers or claims. Do not let historical data override material current squad or manager changes.
